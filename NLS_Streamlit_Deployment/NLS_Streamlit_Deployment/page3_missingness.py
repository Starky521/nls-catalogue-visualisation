    ...
    figure.update_layout(
        ...
        annotations=[
            dict(x=0.00, y=1.06, xref="paper", yref="paper",
                 text="<b>Material type</b>", showarrow=False, xanchor="left"),
            dict(x=0.34, y=1.06, xref="paper", yref="paper",
                 text="<b>Date information</b>", showarrow=False),
            dict(x=0.67, y=1.06, xref="paper", yref="paper",
                 text="<b>Publisher information</b>", showarrow=False),
            dict(x=1.00, y=1.06, xref="paper", yref="paper",
                 text="<b>Publication-place result</b>",
